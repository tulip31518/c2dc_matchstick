...
cc.Class({
    ...
    get_pattern_square: function(index)
    {
        var result = [                     
            ...
            [[0,1,2,3,4,5,6]],
            [[0,6,5],[7,1,8],[8,2,9],[9,3,10],[4,5,10]],                                    //15
            [[0,3,4,6]],
            [[0,1,2,3,4,5,6,8,9,12,13,14,16,17,21,22]],                                 
            [[0,12,19,11],[10,19,23,18], [8,9,17,18],[1,13,20,12],[20,21,22,23],[22,16,7,17],[2,3,13,14],[21,14,4,15],[5,6,10,15],
            ...
            [[0,11,12,19],[1,12,13,20],[2,13,14,21],[3,4,14,15],[9,10,18,19],[8,17,18,20],[7,16,17,21],[5,6,15,160,1,13,178,9,10,11]
